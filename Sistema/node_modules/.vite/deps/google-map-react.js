import {
  require_prop_types
} from "./chunk-LKCEZMH7.js";
import {
  require_react_dom
} from "./chunk-3L24SQ2Z.js";
import {
  require_react
} from "./chunk-I434CI6H.js";
import {
  __commonJS,
  __toESM
  ...
  setScript() {
    ...
    if (!((_b = (_a = window === null || window === void 0 ? void 0 : window.google) === null || _a === void 0 ? void 0 : _a.maps) === null || _b === void 0 ? void 0 : _b.importLibrary)) {
      ((g2) => {
        ...
        b2 = b2[c2] || (b2[c2] = {});
        const d2 = b2.maps || (b2.maps = {}), r2 = /* @__PURE__ */ new Set(), e2 = new URLSearchParams(), u2 = () => h2 || (h2 = new Promise((f2, n2) => __awaiter(this, void 0, void 0, function* () {
          var _a2;
...
var ce = function(t2) {
  function o2(o3) {
    ...
    if ((r3 = t2.call(this, o3) || this)._getMinZoom = function() {
        ...
        r3.props.googleMapLoader(t3, r3.props.heatmapLibrary).then(function(e3) {
          if (r3.mounted_) {
            ...
            r3.overlay_ = M2, M2.setMap(g2), r3.props.heatmap.positions && r3.heatmap.setMap(g2), r3.props.onTilesLoaded && e3.event.addListener(g2, "tilesloaded", function() {
              ...
              v2.geoService_.getZoom() !== g2.getZoom() && (v2.zoomAnimationInProgress_ || (v2.zoomAnimationInProgress_ = true, v2._onZoomAnimationStart(g2.zoom)), f2 < 32) && (new Date().getTime() - r3.zoomControlClickTime_ < 300 ? E(function() {
                return E(function() {
      ...
      var e2;
      return r3.props.onClick && !r3.childMouseDownArgs_ && new Date().getTime() - r3.childMouseUpTime_ > 300 && 0 === r3.dragTime_ && (e2 = r3.props).onClick.apply(e2, arguments);
    }, r3._onMapClick = function(e2) {
      r3.markersDispatcher_ && (r3._onMapMouseMove(e2), new Date().getTime() - r3.dragTime_ > 100 && (r3.mouse_ && r3._onClick(a({}, r3.mouse_, { event: e2 })), r3.markersDispatcher_.emit("kON_CLICK", e2)));
    }, r3._onMapMouseDownNative = function(e2) {
      r3.mouseInMap_ && r3._onMapMouseDown(e2);
    }, r3._onMapMouseDown = function(e2) {
      r3.markersDispatcher_ && new Date().getTime() - r3.dragTime_ > 100 && (r3._onMapMouseMove(e2), r3.markersDispatcher_.emit("kON_MDOWN", e2));
    }, r3._onMapMouseDownCapture = function() {
      U().isChrome && (r3.zoomControlClickTime_ = new Date().getTime());
...
// dep:google-map-react
var google_map_react_default = index_modern_default;
export {
  _e as convertNeSwToNwSe,
  fe as convertNwSeToNeSw,
  google_map_react_default as default,
  ve as fitBounds,
  we as getTilesIds,
  Ce as latLng2Tile,
